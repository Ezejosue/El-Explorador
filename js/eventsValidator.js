    ...
    contenido += `
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <label for="txtFechaRealizacion" class="form-label tituloCampo">Fecha de
                realización</label>
            <input type="date" class="form-control txt" id="txtFechaRealizacion"
                    placeholder="Ingrese fecha de realización" min="${fechaMostrar}" required>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <label for="txtFechaInicio" class="form-label tituloCampo">Hora de
                    realización</label>
                <input type="time" class="form-control txt" id="txtFechaInicio"
